...
const zhCN: LocaleTranslations = {
  ...
  error: {
    ...
    coreConfigRejected: '内核拒绝了该配置',
    profileReverted: '更改已回滚',
...
const enUS: LocaleTranslations = {
  ...
  error: {
    ...
    coreConfigRejected: 'Core rejected the configuration',
    profileReverted: 'The change was reverted',
...
const ruRU: LocaleTranslations = {
  ...
  error: {
    ...
    coreConfigRejected: 'Ядро отклонило конфигурацию',
    profileReverted: 'Изменения отменены',
    profileCheckFailed: 'Проверка конфигурации не пройдена',
